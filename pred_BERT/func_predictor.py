# -*- coding: utf-8 -*-
# @Author: Yihe Pang
# @Date:   2022-10-17 18:21:34
# @Last Modified by:   Yihe Pang
# @Last Modified time: 2022-12-27 12:36:45
import numpy as np 
import random
import os
...
def run_pred_func_BERT(data_file_name,results_path,select_func):
	#模型配置参数
	args = Args_config()
	...
	for root, dirs, files in os.walk(model_path):
		for one_file in files:
			model_file = model_path+'/'+one_file
